=head1 BaselinerX::CA::Endevor::WSAPI

Access Endevor through its web services.

=cut
package BaselinerX::CA::Endevor::WSAPI;
use Baseliner::Plug;
...
sub _call_endevor {
    ...
    #print Dump $som->body;
    #print "RES=" . $som->body->{isUserAuthenticResponse}->{isUserAuthenticReturn}; 
}
